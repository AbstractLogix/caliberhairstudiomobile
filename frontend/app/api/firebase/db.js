    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, firestore_1.addDoc)((0, firestore_1.collection)((0, firestore_1.getFirestore)(), 'artists'), {
                            name: artistName,
                            bio: artistBio
                        })];
                case 1:
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error writing new message to Firebase Database', error_1);
                    return [3 /*break*/, 3];
...
function getArtists(db) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = (0, firestore_1.query)((0, firestore_1.collection)(db, "artists"));
